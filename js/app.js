(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".swiper-mainpage__slider")) new swiper_core_Swiper(".swiper-mainpage__slider", {
            ...
            if (document.querySelector(".swiper-showroom-mainpage__slider")) new swiper_core_Swiper(".swiper-showroom-mainpage__slider", {
                modules: [ Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".cart-tovar__swiper")) new swiper_core_Swiper(".cart-tovar__swiper", {
                modules: [ Navigation, Pagination, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
            ...
            if (document.querySelector(".buy__slider")) new swiper_core_Swiper(".buy__slider", {
                modules: [ Navigation, Pagination, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
            ...
            var swiper = new swiper_core_Swiper(".mySwiper", {
                modules: [],
                spaceBetween: 0,
                slidesPerView: 0,
                freeMode: false,
        ...
        da.init();
        document.querySelectorAll(".header-body-menu__link");
        document.querySelectorAll(".header-body-menu__sub-list");
        const slej = document.querySelector(".header-body-menu__list");
        const screenWidth = window.screen.width;
        console.log(screenWidth);
        const listItems = document.querySelectorAll(".header-body-menu__iteme");
        if (listItems.length) listItems.forEach((listItem => {
            listItem.addEventListener("click", (function(e) {
                const targetElement = e.target;
                if (targetElement.closest(".header-body-menu__iteme")) {
                    listItem.lastElementChild.classList.toggle("_active");
                    listItem.classList.toggle("_active");
                    slej.classList.toggle("_slej");
                } else if (targetElement.closest(".header-body-menu__iteme")) slej.classList.remove("_slej");
            }));
        }));
        const mobileMenus = document.querySelectorAll(".mobile-footer__link");
        if (mobileMenus.length) mobileMenus.forEach((mobileMenu => {
            mobileMenu.addEventListener("click", (function(e) {
                const targetElement = e.target;
                e.preventDefault();
                if (targetElement.closest(".mobile-footer__link")) {
                    mobileMenu.parentNode.classList.toggle("_active");
                    mobileMenu.classList.toggle("_active");
                }
            }));
        }));
        const liks = document.querySelectorAll(".product__favorite");
        document.querySelectorAll(".product__like");
        document.querySelectorAll(".product__box ");
        if (liks.length) ;
        window["FLS"] = true;
        isWebp();
        addTouchClass();
